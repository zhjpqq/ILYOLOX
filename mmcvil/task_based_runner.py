...
from mmcv.runner.checkpoint import save_checkpoint, load_checkpoint, _load_checkpoint, load_state_dict
...
class TaskEpochBasedRunner(BaseRunner):
    ...
    def XXload_checkpoint(self,
                        filename,
                        map_location='cpu',
                        strict=False,
                        revise_keys=[(r'^module.', '')]):
        checkpoint = _load_checkpoint(filename, map_location, self.logger)
