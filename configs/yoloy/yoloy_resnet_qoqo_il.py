_base_ = [
    ...
    '../_base_/datasets/qoqo_detection_aug1.py',
    # '../_base_/datasets/mini_detection.py',
    '../_base_/default_runtime.py']

# task settings
task = dict(
    resume_by_task=[False, 1, 2, 3][2],
    resume_by_epoch='',
    Task1={
        'load_teacher': 0,
        'load_student': 0,
        'teacher_config': '/home/softlink/zhjproj/now-projects/xmdet220/configs/yoloy/yoloy_resnet_qoqo_il.py',
    ...
    Task2={
        ...
        # ResNet-18
        'teacher_config': '/home/softlink/zhjproj/now-projects/xmdet220/configs/yoloy/yoloy_resnet_qoqo_il.py',
        # 'teacher_ckpt': '/home/softlink/zhjpexp/yoloy_r18_st4gb16_qoqo_il44r_x0_msresp/task_1_epoch_12.pth',
        # 'student_ckpt': '/home/softlink/zhjpexp/yoloy_r18_st4gb16_qoqo_il44r_x0_msresp/task_1_epoch_12.pth',
        ...
        # 'teacher_ckpt': '/home/softlink/zhjpexp/yoloy_r18_st4gb16_qoqo_il53_x2_hard/task_1_epoch_12.pth',
        # 'student_ckpt': '/home/softlink/zhjpexp/yoloy_r18_st4gb16_qoqo_il53_x2_hard/task_1_epoch_12.pth',
        # 'teacher_ckpt': '/home/softlink/zhjpexp/yoloy_r18_st4gb16_qoqo_il62_x1_hard/task_1_epoch_12.pth',
        # 'student_ckpt': '/home/softlink/zhjpexp/yoloy_r18_st4gb16_qoqo_il62_x1_hard/task_1_epoch_12.pth',
        # 'teacher_ckpt': '/home/softlink/zhjpexp/yoloy_r18_st4gb16_qoqo_il71_x1_hard/task_1_epoch_12.pth',
        # 'student_ckpt': '/home/softlink/zhjpexp/yoloy_r18_st4gb16_qoqo_il71_x1_hard/task_1_epoch_12.pth',
        # ResNet-50
        # 'teacher_ckpt': '/home/softlink/zhjpexp/yoloy_r50_st4gb16_qoqo_il44_x1_hard/task_1_epoch_12.pth',
        # 'student_ckpt': '/home/softlink/zhjpexp/yoloy_r50_st4gb16_qoqo_il44_x1_hard/task_1_epoch_12.pth',
        # 'teacher_ckpt': '/home/softlink/zhjpexp/yoloy_r50_st4gb16_qoqo_il53_x1_hard/task_1_epoch_12.pth',
        # 'student_ckpt': '/home/softlink/zhjpexp/yoloy_r50_st4gb16_qoqo_il53_x1_hard/task_1_epoch_12.pth',
        # 'teacher_ckpt': '/home/softlink/zhjpexp/yoloy_r50_st4gb16_qoqo_il62_x1_hard/task_1_epoch_12.pth',
        # 'student_ckpt': '/home/softlink/zhjpexp/yoloy_r50_st4gb16_qoqo_il62_x1_hard/task_1_epoch_12.pth',
        'teacher_ckpt': '/home/softlink/zhjpexp/yoloy_r50_st4gb16_qoqo_il71_x1_hard/task_1_epoch_12.pth',
        'student_ckpt': '/home/softlink/zhjpexp/yoloy_r50_st4gb16_qoqo_il71_x1_hard/task_1_epoch_12.pth',
    },
)
...
model = dict(
    ...
    bbox_head=dict(
        ...
        which_index='posandprev + ',  # labelwprev + (posandprev | posnoprev)
        active_score=False,
        mixxed_score=False,
        hybrid_score=False,
        onehot_score=False,
        target_type=['hard', 'soft'][0],
        active_funct='none',
        loss_distill='v0',
        alpha_distill={'total': 1, 'cls': 1, 'loc': 1},     # labelwprev 开启或关闭
        cates_distill='hard + soft',     # hard + soft + obj
        locat_distill='box + iou',       # box + iou + soft + (#decode & #encode)
        feats_distill='',                # kldv
    ...
    # 配置Teacher的测试输出
    teacher_test_cfg=dict(score_thr=0.3, score_thr_small=-3,
                          score_thr_center=0.3, score_thr_other=0.1, iou_thr_other=0.65,
                          size_thr_big=256, size_thr_small=32,
                          nms=dict(type='nms', iou_threshold=0.95),
                          method='all_by_one'),
    # method 'all_by_one | scale | cls_mean_std | all_mean_std | re_sampling'
)
...
# catsplit, catload = (40, 20, 20), (1, 0, 0)
# catsplit, catload = (40, 10, 10, 10, 10), (1, 0, 0, 0, 0)
