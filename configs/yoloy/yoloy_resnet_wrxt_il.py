...
task = dict(
    ...
    Task1={
        'load_teacher': 0,
        'load_student': 0,
        'teacher_config': '/home/zhangjp/projects/now-projects/xmdet220/configs/yoloy/yoloy_resnet_wrxt_il.py',
        'teacher_ckpt': '/home/softlink/zhjpexp/common_exp_il/task_1_epoch_6.pth',
        'student_ckpt': '/home/softlink/zhjpexp/common_exp_il/task_1_epoch_6.pth',
    },
    Task2={
        'load_teacher': 1,
        'load_student': 1,
        'teacher_config': '/home/zhangjp/projects/now-projects/xmdet220/configs/yoloy/yoloy_resnet_wrxt_il.py',
        # 'teacher_ckpt': '/home/softlink/zhjpexp/common_exp_il/task_2_epoch_6.pth',
        # 'student_ckpt': '/home/softlink/zhjpexp/common_exp_il/task_2_epoch_6.pth',
        ...
        'teacher_ckpt': '/home/softlink/zhjpexp/yoloy_r18_stst_wrxt_g4b8_il54_hard/task_1_epoch_12.pth',
        'student_ckpt': '/home/softlink/zhjpexp/yoloy_r18_stst_wrxt_g4b8_il54_hard/task_1_epoch_12.pth',
        # 'teacher_ckpt': '/home/softlink/zhjpexp/yoloy-r18-stst-wrxt-il54-v2/task_1_epoch_12.pth',
        # 'student_ckpt': '/home/softlink/zhjpexp/yoloy-r18-stst-wrxt-il54-v2/task_1_epoch_12.pth',
    },
)
...
model = dict(
    ...
    bbox_head=dict(
        ...
        which_index='posnoprev + ',  # labelwprev + (posandprev | posnoprev)
        active_score=False,
        mixxed_score=False,
        hybrid_score='hy1',
        onehot_score=False,
        target_type=['hard', 'soft'][1],
        active_funct='none',
        loss_distill='v3',
        alpha_distill={'cls': 1, 'loc': 1, 'feat': 1},    # 蒸馏损失权重，默认为1
        cates_distill='hard + soft',        # hard + soft + obj
        locat_distill='iou',                # box + iou + soft + (#decode & #encode)
        feats_distill='',                   # kldv
...
catsplit, catload = (5, 4), (1, 1)
# catsplit, catload = (7, 2), (1, 1)
# catsplit, catload = (3, 3, 3), (1, 0, 0)
