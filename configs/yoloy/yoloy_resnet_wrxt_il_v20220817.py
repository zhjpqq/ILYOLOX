...
model = dict(
    ...
    # neck=dict(
    #      # mmdet/models/utils/involution_cuda.py open here!!!
    #     type='PAFPN_IVneck',
    #     in_channels=[128, 256, 512],
    #     out_channels=128,
    #     num_csp_blocks=1,
    ...
    # 配置Teacher的测试输出
    teacher_test_cfg=dict(score_thr=0.1, score_thr_small=-3, size_thr_big=256,
...
runner = dict(type='TaskEpochBasedRunner', max_epochs=6, max_tasks=task_nums, save_teacher=False)
runner = [runner] * task_nums

log_config = dict(interval=50)   # org 100